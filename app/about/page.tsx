            ...
            <Card className="index-card mx-auto max-w-2xl">
              <CardContent className="p-6 flex flex-col gap-4">
                ...
                <p className="text-muted-foreground">
                  ...
                  writers, and professionals found themselves in a shared state
                  of creative drought, yearning for meaning beyond productivity
                  metrics.
                </p>
                <p className="text-muted-foreground">
                  The world had become too efficient, too polished, too focused
                  on outcomes. We were losing the sacred joy of creation for its
                  own sake, the messy middle, the delicious uncertainty of play.
                </p>
              </CardContent>
            </Card>
          </ScrollRevealItem>
            ...
            <Card className="index-card mx-auto max-w-2xl rotate-[-1deg]">
              <CardContent className="p-6 flex flex-col gap-4">
                ...
                <p className="text-muted-foreground">
                  ...
                  over video calls. We shared our frustrations, our longings,
                  our half-forgotten creative dreams. We created rituals—small,
                  intentional practices that reconnected us to our innate
                  creative wisdom.
                </p>
                <p className="text-muted-foreground">
                  With each gathering, we discovered something profound: the
                  creative process itself—messy, unpredictable, and deeply
                  human—was the very thing we were missing in our optimized
                  lives.
                </p>
              </CardContent>
            </Card>
          ...
          <ScrollRevealItem delay={300}>
            <Card className="index-card mx-auto max-w-2xl rotate-[1deg]">
              <CardContent className="p-6 flex flex-col gap-4">
                ...
                <p className="text-muted-foreground">
                  This wasn&apos;t about making &quot;better art&quot; or
                  becoming &quot;more productive creatives.&quot; It was about
                  remembering that creativity is our birthright—a way of being
            ...
            <Card className="index-card mx-auto max-w-2xl rotate-[-0.5deg]">
              <CardContent className="p-6 flex flex-col gap-4">
                ...
                <p className="text-muted-foreground">
                  ...
                  zines, and create spaces—both digital and physical—where
                  people can reconnect with their creative essence.
                </p>
                <p className="text-muted-foreground">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <ScrollRevealItem delay={0}>
            <div className="flex flex-col gap-2">
              ...
              <p className="text-muted-foreground">
                We honor play as a profound act. Whimsy, experimentation, and
                joy are not frivolous—they&apos;re essential.
              </p>
            </div>
          </ScrollRevealItem>
