        ...
        <div className="relative z-10 flex flex-col items-center gap-8 md:gap-12 py-12">
          <ScrollRevealItem delay={0}>
            <div className="space-y-6">
              <div className="text-sm uppercase tracking-widest text-primary/80 font-mono mb-2">
                The creative process
              </div>
              <h1 className="font-serif text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl lg:text-7x">
                The Poetic{" "}
            ...
            <Card className="index-card hover-lift">
              <CardContent className="p-6 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-muted-foreground">
                    Structured practices to help you unlock your creativity,
                    break through blocks, and establish consistent creative
                    habits.
                  </p>
                </div>
              </CardContent>
            ...
            <Card className="index-card rotate-[-1deg] hover-lift">
              <CardContent className="p-6 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-muted-foreground">
                    A space to experiment with new forms, media, and
                    perspectives without the pressure of perfection or
                    productivity.
                  </p>
                </div>
              </CardContent>
