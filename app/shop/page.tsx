...
const products = [
  {
    ...
    description:
      "Our hand-printed zine that outlines the core philosophy of The Poetic Toolbox movement.",
    price: 15,
  ...
  },
  {
    ...
    description:
      "A deck of 52 cards with creative rituals and prompts to spark your imagination daily.",
    price: 25,
  ...
  },
  {
    ...
    name: "Field Notebook",
    description:
      "Hand-bound notebook with prompts, blank pages, and creative exercises to document your journey.",
    price: 18,
  ...
  },
  {
    ...
    description:
      "A collection of physical tools and materials to engage your senses during creative practice.",
    price: 45,
  ...
  },
  {
    ...
    description:
      "Set of 10 letterpress postcards featuring poetic prompts and artistic illustrations.",
    price: 12,
  ...
  },
  {
    ...
    description:
      "Digital course with 8 modules to help you develop a sustainable creative practice.",
    price: 75,
    image: "/globe.svg", // placeholder - would be actual product image
    category: "Digital",
    featured: false,
        ...
        <div className="space-y-4">
          ...
          <ScrollRevealItem delay={300}>
            <p className="mx-auto max-w-[700px] text-lg text-muted-foreground">
              Tactile tools, thoughtfully designed artifacts, and creative
              resources to support your journey back to creative reconnection.
            </p>
          </ScrollRevealItem>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl space-y-6">
        ...
        <div className="scrapbook-grid">
          {products
            ...
            .map((product, index) => (
              <ScrollRevealItem key={product.id} delay={index * 150}>
      ...
      <section className="mx-auto max-w-2xl rounded-lg border-2 bg-muted/50 p-8 text-center">
        ...
        <ScrollRevealItem delay={150}>
          <p className="mt-4 text-muted-foreground">
            We create bespoke creative tools and resources for individuals and
            organizations. Get in touch to discuss your needs.
          </p>
        </ScrollRevealItem>
